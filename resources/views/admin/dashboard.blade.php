  ...
  <div class="row m-5">
    <div class="col-3">
      <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        <a class="nav-link " id="v-pills-memoires-tab" data-toggle="pill" href="#v-pills-memoires" role="tab" aria-controls="v-pills-memoires" aria-selected="true">Etat de la BDD</a>
        <a class="nav-link active" id="v-pills-informations-tab" data-toggle="pill" href="#v-pills-informations" role="tab" aria-controls="v-pills-informations" aria-selected="false">Données</a>
