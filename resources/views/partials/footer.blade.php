    ...
    <div class="footer sticky-bottom">
        ...
        <hr>
        <h3 class="text-center">Les partenaires</h3><br><br>
        <div class="row pb-2">
          
          <div class="col-lg-4 col-md-6 col-sm-12 "><p class="text-center"><img src="https://via.placeholder.com/150" alt=""></p></div>
          <div class="col-lg-4 col-md-6 col-sm-12"><p class="text-center"><img src="https://via.placeholder.com/150" alt=""></p></div>
          <div class="col-lg-4 col-md-6 col-sm-12"><p class="text-center"><img src="https://via.placeholder.com/150" alt=""></p></div>
        </div>
