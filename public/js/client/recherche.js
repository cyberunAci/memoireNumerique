...
/***/ "./resources/js/client/recherche.js":
/*!******************************************!*\
  !*** ./resources/js/client/recherche.js ***!
  \******************************************/
...
$("#barreRecherche").keypress(function (event) {
  // pour enlever la touche entre (retour à la ligne) et lancer la recherche
  if (event.which == 13) {
    lancerRecherche();
  }
});
$("#btnRecherche").click(function (event) {
  //lance la recherche quand on click sur la loupe
  lancerRecherche();
});

function lancerRecherche() {
  //lance la recherche
  var recherche = $("#barreRecherche").val();
...
/***/ 3:
/*!************************************************!*\
  !*** multi ./resources/js/client/recherche.js ***!
  \************************************************/
/*! no static exports found */
